...
class ClownsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create clown" do
    assert_difference("Clown.count") do
      post clowns_url, params: { clown: { cost: @clown.cost, description: @clown.description, name: @clown.name } }
    end
  ...
  test "should update clown" do
    patch clown_url(@clown), params: { clown: { cost: @clown.cost, description: @clown.description, name: @clown.name } }
